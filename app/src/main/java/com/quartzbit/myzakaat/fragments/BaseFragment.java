...
public class BaseFragment extends Fragment {
    ...
    public void initBase(LayoutInflater inflater, ViewGroup container,
        ...
        txtMessage = (TextViewWithImage) lytBase.findViewById(R.id.txt_default_message_base_fragment);
...
/*                Glide.with(App.getInstance().getApplicationContext())
        ...
        if (isTransparentBackground) {
            lytMessage.setBackgroundColor(ContextCompat.getColor(App.getInstance().getApplicationContext(), R.color.transparent));
        } else {
            lytMessage.setBackgroundColor(ContextCompat.getColor(App.getInstance().getApplicationContext(), R.color.white));
        }
    }
