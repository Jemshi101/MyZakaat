...
public class FileOp {
    ...
    private static final String APP_FOLDER = "/Dearest";
    private static final String APP_TEMP_FOLDER = "/Dearest/Photo";
    private static final String SEPARATOR = "/";
    private static final String TAG = "FileOp";
    public static final String FILTER_FOLDER = "/Dearest/Filters";
    public static final String APP_SENT_PHOTO_FOLDER = "/Dearest/Sent/Photos";
    public static final String APP_SENT_VIDEO_FOLDER = "/Dearest/Sent/Videos";
    private final Context context;
    private FileOutputStream fos;
    private OutputStreamWriter osw;
    private File file;
    private final String pathEx = Environment.getExternalStorageDirectory() + "/Dearest/";
    ...
    private void createProjectFolder() {
        ...
        if (Environment.getExternalStorageState() != null) {
            ...
            file = new File(Environment.getExternalStorageDirectory() +
                    SEPARATOR + APP_SENT_PHOTO_FOLDER + SEPARATOR);
            if (!file.exists()) {
                file.mkdirs();
            }
            file = new File(Environment.getExternalStorageDirectory() +
                    SEPARATOR + APP_SENT_VIDEO_FOLDER + SEPARATOR);
            if (!file.exists()) {
                file.mkdirs();
            }
            file = new File(Environment.getExternalStorageDirectory() +
                    SEPARATOR + FILTER_FOLDER + SEPARATOR);
            if (!file.exists()) {
                file.mkdirs();
            }
        }
    ...
    public BasicDataBean readBasicDataBean() {
        BasicDataBean x = null;


        try {
            fis = context.openFileInput("BasicDataBean.dat");
            ois = new ObjectInputStream(fis);
            x = (BasicDataBean) ois.readObject();
            ois.close();
        } catch (ClassNotFoundException | IOException e) {
            e.printStackTrace();
        }
    ...
    public void writeBasicDataBean(BasicDataBean bean) {

        try {
            fos = context.openFileOutput("BasicDataBean.dat", MODE_PRIVATE);
...
//        path = context.getFilesDir() + "/images/profile_photo.jpg";
    ...
    public static String getVideoPath() {
        ...
        boolean flag = false;
        int i = 0;
        for (i = 0; i < getVideoCount(); i++) {
            imagePathTemp = Environment.getExternalStorageDirectory() +
                    APP_SENT_VIDEO_FOLDER + SEPARATOR + "video_" + i + ".mp4";
        ...
        if (flag) {
            return imagePathTemp = Environment.getExternalStorageDirectory() +
                    APP_SENT_VIDEO_FOLDER + SEPARATOR + "video_" + i + ".mp4";
        } else {
            return imagePathTemp = Environment.getExternalStorageDirectory() +
                    APP_SENT_VIDEO_FOLDER + SEPARATOR + "video_" + getVideoCount() + ".mp4";
        }
    }
    ...
    public static String getPhotoPath() {
        ...
        for (i = 0; i < getPhotoCount(); i++) {
            imagePathTemp = Environment.getExternalStorageDirectory() +
                    APP_SENT_PHOTO_FOLDER + SEPARATOR + "photo_" + i + ".jpg";
        ...
        if (flag) {
            ...
            return imagePathTemp = Environment.getExternalStorageDirectory() +
                    APP_SENT_PHOTO_FOLDER + SEPARATOR + "photo_" + getPhotoCount() + ".jpg";
        }
    }

    public static String getFilterPath(String filename) {
        return Environment.getExternalStorageDirectory() +
                FILTER_FOLDER + SEPARATOR + "filter_" + filename + ".jpg";
    }

    public static String getVideoTempPath() {
        return Environment.getExternalStorageDirectory() +
                APP_SENT_VIDEO_FOLDER + SEPARATOR + "temp.mp4";
    }

    public static String getVideoTrimPath() {
        return Environment.getExternalStorageDirectory() +
                APP_SENT_VIDEO_FOLDER + SEPARATOR + "trim.mp4";
    }
    ...
    public static String getPostID() {
        ...
        for (i = 0; i < getPostImagesCount(); i++) {
            imagePathTemp = Environment.getExternalStorageDirectory() +
                    SEPARATOR + APP_TEMP_FOLDER + SEPARATOR + "post_" + i + ".jpg";
    ...
    private static int getPostImagesCount() {
        ...
        File dir = new File(Environment.getExternalStorageDirectory() +
                SEPARATOR + APP_TEMP_FOLDER + SEPARATOR);
    ...
    public static String getPhotoID() {
        ...
        for (i = 0; i < getPhotoCount(); i++) {
            imagePathTemp = Environment.getExternalStorageDirectory() +
                    SEPARATOR + APP_TEMP_FOLDER + SEPARATOR + "photo_" + i + ".jpg";
    ...
    private static int getVideoCount() {
        ...
        String[] filesIn;
        File dir = new File(Environment.getExternalStorageDirectory() +
                APP_SENT_VIDEO_FOLDER + SEPARATOR);
        filesIn = dir.list(new FilenameFilter() {
    ...
    private static int getPhotoCount() {
        ...
        String[] filesIn;
        File dir = new File(Environment.getExternalStorageDirectory() +
                APP_SENT_PHOTO_FOLDER + SEPARATOR);
        filesIn = dir.list(new FilenameFilter() {
